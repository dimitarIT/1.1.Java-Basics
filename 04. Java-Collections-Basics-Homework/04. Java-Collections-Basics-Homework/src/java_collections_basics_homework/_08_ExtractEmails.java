...
// separate line. Emails are considered to be in format <user>@<host>, where:
// • <user> is a sequence of letters and digits, where '.', '-' and '_' can
// appear between them. Examples of valid users: "stephan", "mike03",
// "s.johnson", "st_steward", "softuni-bulgaria", "12345". Examples of invalid
// users: ''--123", ".....", "nakov_-", "_steve", ".info".
// • <host> is a sequence of at least two words, separated by dots '.'. Each
// word is sequence of letters and can have hyphens '-' between the letters.
