...
public class _09_GaneratePDF_DeckOfCards {
	
	public static void main(String[] args) {
		try {
			Document document = new Document();
			PdfWriter.getInstance(document, new FileOutputStream("_09_GaneratePDF_DeckOfCards.pdf"));			
			document.open();
			...
			Font black = new Font(baseFont, 55f, 0, BaseColor.BLACK);
			Font red = new Font(baseFont, 55f, 0, BaseColor.RED);
